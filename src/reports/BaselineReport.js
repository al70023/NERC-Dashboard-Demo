            ...
            >
                <Modal.Dialog>
                    <Modal.Header style={{ justifyContent: "center" }}>
                        <Modal.Title>Baseline Report</Modal.Title>
                    </Modal.Header>

                    <Modal.Body style={{ textAlign: "center" }}>
                        <br></br>
                        <h6>Generate snapshot of baseline as of:</h6>

                        <h6>{formatDate(new Date().toISOString().split('T')[0])}</h6>
                                    ...
                                    <Row>
                                        <Col>
                                            <Button
                                                ...
                                                variant="contained"
                                                color="primary"
                                                style={{ marginTop: "27px", paddingLeft: "15px", paddingRight: "15px", textTransform: "none" }}
                                                startIcon={<DownloadIcon />}
                                            // onClick={() => exportPDF()}
                                            >
                                                Download PDF Report
